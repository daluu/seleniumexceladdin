...
{
    public class AssertSelectedValuesCommand : ITestCommand
    {
        ...
        public string Description
        {
            get
            {
                return TestCommandResource.AssertSelectedValues;
            }
        }
        ...
        public string TargetDescription
        {
            get
            {
                return TestCommandResource.AssertSelectedValues_Target;
            }
        }
        ...
        public string ValueDescription
        {
            get
            {
                return TestCommandResource.AssertSelectedValues_Value;
            }
        }
