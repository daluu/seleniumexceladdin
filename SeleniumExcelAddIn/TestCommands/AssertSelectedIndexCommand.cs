...
{
    public class AssertSelectedIndexCommand : ITestCommand
    {
        ...
        public string Description
        {
            get
            {
                return TestCommandResource.AssertSelectedIndex;
            }
        }
        ...
        public string TargetDescription
        {
            get
            {
                return TestCommandResource.AssertSelectedIndex_Target;
            }
        }
        ...
        public string ValueDescription
        {
            get
            {
                return TestCommandResource.AssertSelectedIndex_Value;
            }
        }
        ...
        public static IEnumerable<string> GetActual(ITestContext context)
        {
            ...
            for (int i = 0; i < selectElement.Options.Count; i++)
            {
                ...
                {
                    actual.Add(i.ToString(CultureInfo.InvariantCulture));
                }
            }
