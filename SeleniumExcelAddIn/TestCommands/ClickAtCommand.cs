...
{
    public class ClickAtCommand : ITestCommand
    {
        ...
        public string Description
        {
            get
            {
                return TestCommandResource.ClickAt;
            }
        }
        ...
        public string TargetDescription
        {
            get
            {
                return TestCommandResource.ClickAt_Target;
            }
        }
        ...
        public string ValueDescription
        {
            get
            {
                return TestCommandResource.ClickAt_Value;
            }
        }
